...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.activation_prime = lambda x : (1.0/(1.0+np.exp(-x))) *  (1.0 - 1.0/(1.0 + np.exp(-x)) )  # Replace 0 with your sigmoid calculation.
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = final_inputs # signals from final output layer, no activation since a regression problem
